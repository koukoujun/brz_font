...
<script>
  ...
  import { cvDetailTable} from '@/libs/data-staffmange'
  ...
  export default {
    data () {
      return {
        ...
        col:[
          ...
          {
            title:'跟单次数',
            key:'COUNT(customer_id)',
            className:"demo-table-info-column_07"
          },
          {
            title:'今日消费额',
            key:'today',
    ...
    rowClassName (row, index) {
      ...
      initData () {
        ...
        //请求接口
        apiRequest(api.Payment.indexCount,
          params,
          ret => {
            this.data = ret
          })
...
<style>
    ...
    .ivu-table td.demo-table-info-column_07{
        background-color: #2db7f5;
        color: #fff;
        font-size:1.2rem;
    }
