  ...
  export default {
    ...
    methods: {
      ...
      initData () {
        ...
        apiRequest(api.Documentary.highPointIndex,
          params,
          ret => {
            this.data = ret
      ...
      //跳转查看顾问跟单数据
      pushLook(row){
         this.$router.push({path: '/high_admin/history_documentary',query:{ id:row.customer_id}});
      },
      //导出数据表
      exportData (type) {
          if (type === 1) {
          ...
          //导出所有数据
              ...
              for(a;a<=b;a++){
                 ...
                 apiRequest(api.Documentary.highPointIndex,params,ret => {
